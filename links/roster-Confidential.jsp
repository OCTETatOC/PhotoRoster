...
If you are interested in making the photos available to your students, go to your course menu and make the 'Student Roster' tool available.<br/></i></span>
		...
		<a href="/webapps/blackboard/email/caret.jsp?family=cp_send_email&course_id=<%= request.getParameter("course_id") %> ">email all students/participants in this site</a>
		<%
