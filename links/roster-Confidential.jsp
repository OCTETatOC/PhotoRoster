...
If you are interested in making the photos available to your students, go to your course menu and make the 'Student Roster' tool available.<br/></i></span>
		...
		<a href="/webapps/blackboard/execute/displayEmail?navItem=cp_send_email_all_students&course_id=<%Id courseId = bbPm.generateId(Course.DATA_TYPE, request.getParameter("course_id"));%> ">email all students/participants in this site</a>
		<%
