...
<tr><td colspan="5"><span class="style1">INSTRUCTOR(S)</span></td></tr>
		...
		{ 
			...
			i++;
			%>
			<td width="170"><div align="center">Teaching Asst.<br/><img height="100px" src="https://octet1.csr.oberlin.edu/octet/Bb/Photos/expo/<%=thisUserTA.getUserName()%>/profileImage" onError="imageError(this)">			
				<br/>
		...
		{ 
			...
			i++;
			%>
			<td width="170"><div valign="top" align="center" id="RoundedDiv"><img height="120px" src="https://octet1.csr.oberlin.edu/octet/Bb/Photos/expo/<%=thisUserStu.getUserName()%>/profileImage" onError="imageError(this)">
				<br/>
